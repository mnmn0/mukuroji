...
import { requiresFreshEnterpriseAuthentication } from './enterpriseAuthentication'
import { clearAuthSession } from '../auth/session'
import { parseActiveEnterpriseRecoveryExpiry } from './capabilityBoundary'
import {
...
import { readEnterpriseSecurityTab } from './tabs'
...
const enterpriseSecuritySWRConfig = {
...
export function EnterpriseSecurityPanelContainer({
  ...
  const {
    ...
    securityKey,
    ([, token]) => loadEnterpriseSecuritySnapshot(token),
    enterpriseSecuritySWRConfig,
  )
...
async function loadEnterpriseSecuritySnapshot(accessToken: string) {
  return getEnterpriseSecuritySnapshot(accessToken)
}
