...
const activityLabelKeys: Record<string, MessageKey> = {
  ...
  'context-item.created': 'collaboration.activity.contextItemCreated',
  'context-item.updated': 'collaboration.activity.contextItemUpdated',
  'context-item.superseded': 'collaboration.activity.contextItemSuperseded',
  'accepted-resolution.selected': 'collaboration.activity.acceptedResolutionSelected',
  'accepted-resolution.replaced': 'collaboration.activity.acceptedResolutionReplaced',
  'accepted-resolution.edited': 'collaboration.activity.acceptedResolutionEdited',
