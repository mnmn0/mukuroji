...
const developerPlatformSWRConfig = {
...
export function DeveloperPlatformPanelContainer({
  ...
  const resourceKey = mutationSession.accessToken
    ? (['developer-platform', mutationSession.accessToken] as const)
    : null
  const {
    data: resources,
    error,
  ...
  const {
    ...
    (pageIndex, previousPage) => {
      if (!mutationSession.accessToken) {
        return null
      }
