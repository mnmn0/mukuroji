...
import {
  useDeveloperExternalLinks,
} from '../../developer-platform/queries/useExternalLinks'
import {
  useDeveloperPlatformResources,
} from '../../developer-platform/queries/useDeveloperPlatform'
import {
  createWorkItemExternalLinksLabels,
  type WorkItemExternalLinksLabels,
} from './externalLinkLabels'
...
export function WorkItemExternalLinksPanelContainer({
  ...
  } = useDeveloperPlatformResources(accessToken, canManage)
  ...
  const {
    ...
    setSize,
    size,
  } = useDeveloperExternalLinks(accessToken, teamId, workItemId)
  const links = useMemo(() => {
