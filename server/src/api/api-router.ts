...
function shouldEvaluateEnterpriseProjectScopes(
  ...
  return /^\/api\/(?:analytics|approvals|bulk-operations|document-backlinks|documents|focus|planning|projects|realtime\/tickets|teams|work-item-configuration|work-items)(?:\/|$)/u
    .test(path)
}
