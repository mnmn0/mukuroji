...
const permissionMetadata = {
  ...
  'documents.read': ['content', 'View documents', 'View documents and whiteboards in the assigned scope.', false],
  'documents.write': ['content', 'Edit documents', 'Create and update documents and whiteboards.', false],
  'documents.manage': ['content', 'Manage documents', 'Manage document permissions, sharing, and lifecycle.', false],
