...
export type CreateWorkspaceSearchMigrationManagedDescribeTableRateInput = {
  ...
  /** Complete exact-six physical DescribeTable allowlist. */
...
type ManagedDescribeTableRateConstructionSnapshot = {
  ...
  readonly recoveryTableNames: readonly string[]
  /** Complete detached exact-six DescribeTable allowlist. */
  readonly allowedTableNames: readonly string[]
...
/**
 * Detaches the complete exact-six physical table allowlist.
 *
 ...
 *
 * @param value - Candidate full migration table allowlist.
