...
/**
 * Rejects retired rehearsal-stage capabilities on production construction.
 *
 * The check observes property presence only and never reads candidate values,
 * so accessors cannot expose removed reservation material.
 *
 ...
 *
 * @param snapshot - Validated production session construction.
 * @returns Claimed parent session and subordinate measurement factory.
 */
